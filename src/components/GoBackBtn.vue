...
// todo реализовать проверка маршрута кнопки назад. Если передана по ссылку, то
// todo проверять наличие $router, если нет, то бросать на домашнюю страницу
